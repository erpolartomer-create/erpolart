...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.01) 100%)';
...
const ProfileCardComponent = ({
  ...
  behindGlowColor = 'rgba(92, 115, 255, 0.4)',
  behindGlowSize = '40%',
  className = '',
  enableTilt = true,
      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className="pc-card">
          <div className="pc-inside">
            ...
            {/* Removed pc-details to keep text inside the bar only */}
          </div>
        </section>
      </div>
    </div>
