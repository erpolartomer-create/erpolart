...
const palette = [
  { num: 'text-amber-400',  iconBg: 'bg-amber-400/15',  iconBorder: 'border-amber-400/40',  line: 'bg-amber-400'  },
...
const SaaSFAQ = () => {
  ...
  const items = t('saasPage.faq.items', { returnObjects: true });
  const toggle = (i) => setOpenIndex(openIndex === i ? null : i);

  return (
    <section className="py-16 md:py-28 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-amber-500/5 blur-[140px] rounded-full" />
      </div>
